...
mixin _$ListStore on _ListStore, Store {
  Computed<bool>? _$todoTitleHasDataComputed;

  @override
  bool get todoTitleHasData => (_$todoTitleHasDataComputed ??= Computed<bool>(
          () => super.todoTitleHasData,
          name: '_ListStore.todoTitleHasData'))
      .value;
...
todoTitleHasData: ${todoTitleHasData}
    ''';
  }
}
